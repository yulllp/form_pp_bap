                ...
                <table class="content" width="600" style="border-collapse: collapse; border: 1px solid #cccccc;" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="body" style="padding: 40px; text-align: left; font-size: 16px; line-height: 1.6;">
                            ...
                            @if ($msg->status === 'acc1')
                            <br>
                            BAP ini telah disetujui oleh {{$msg->purchasing->name}} (Purchasing)
                            @elseif($msg->status === 'acc2')
                            <br>
                            BAP ini telah disetujui oleh {{$msg->purchasing->name}} (Purchasing) dan {{$msg->penerima->name}} (Penerima)
                            @endif
                            <br><br>
                        ...
                        <td style="padding: 0px 40px; text-align: center;">
                            <div style="text-align: center;">
                                ...
                                <div style="background-color: #345C72; padding: 10px 20px; border-radius: 5px;">
                                    <a href="http://192.168.4.222:8081/e-form/bap/edit/{{$msg->id}}" target="_blank" style="color: #ffffff; text-decoration: none; font-weight: bold;">Approve disini</a>
                                </div>
                            </div>
                        </td>
                    </tr>
