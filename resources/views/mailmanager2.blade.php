              ...
              <table cellspacing="0" cellpadding="0" style="margin: auto;">
                <tr>
                  <td style="background-color: #345C72; padding: 10px 20px; border-radius: 5px; text-align: center;">
                    ...
                    @elseif($msg->status == 'acc-2')
                    <a href="http://192.168.4.222:8081/e-form/approval/permintaan/{{$msg->id}}" target="_blank" style="color: #ffffff; text-decoration: none; font-weight: bold;">Cek data yang perlu direvisi</a>
                    @endif
                  </td>
                </tr>
              </table>
