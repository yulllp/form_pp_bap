<header class="bg-gray-50 space-x-3 border-b-2 shadow px-4 py-6 sm:px-6 lg:px-8 flex justify-start items-center">
    ...
    <h1 class="text-2xl md:text-xl sm:text-md font-bold leading-tight tracking-tight text-gray-900">{{ $slot }}</h1>
</header>