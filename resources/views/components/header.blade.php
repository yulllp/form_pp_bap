<header class="bg-white space-x-3 lg:space-x-0 shadow px-4 py-4 sm:px-6 lg:px-8 flex justify-start items-center dark:bg-gray-900">
    ...
    <h1 class="text-2xl md:text-xl sm:text-md font-bold leading-tight tracking-tight text-gray-900 dark:text-white">{{ $slot }}</h1>
</header>