<x-layout>
    @section('title', 'Edit - Berita Acara Pengakuan')
    ...
    <section class="bg-white dark:bg-gray-900 w-full px-4 py-4 sm:px-6">
        ...
        <form id="multiStepForm" method="POST" action="{{route('update.bap',$berita->id)}}" class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <!-- Penerima Section -->
            <div class="form-section" id="section1">
                ...
                <div class="mb-4">
                    ...
                    <select id="user_category" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-white">
                        ...
                        @if ($user->id === $berita->penerima->id)
                        <option value="{{$user->id}}" data-department="{{$user->department ? $user->department->nama : 'Belum isi department'}}" selected>{{$user->name}}</option>
                        @else
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="department" id="department-name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white cursor-not-allowed" placeholder="Input otomatis dari nama penerima" value="{{$berita->penerima->department->nama}}" readonly>
                </div>
                <div class="mb-4">
                    <label for="tanggal" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tanggal Penyerahan</label>
                    <input type="date" name="tanggal" id="tanggal" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white cursor-not-allowed" readonly value="{{$berita->tanggal_dibuat}}">
                </div>
                <div class="mb-4">
                    <label for="revisi" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Revisi</label>
                    <textarea name="revisi" id="revisi" rows="4" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white resize-none cursor-not-allowed" readonly>{{ $berita->revisi_pembuat ?? '' }}</textarea>
                </div>
            ...
            <div class="form-section hidden" id="section2">
                ...
                <div class="mb-4">
                    ...
                    <select id="brand" name="brand" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-white">
                        ...
                        @if ($brand->id === $berita->detail_barang->brand->id)
                ...
                <div class="mb-4">
                    ...
                    <select id="type" name="type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-white">
                        ...
                        @if ($type->id === $berita->detail_barang->type->id)
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="spek" id="spek" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{$berita->detail_barang->spesifikasi}}">
                </div>
                <div class="mb-4">
                    <label for="serial" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Serial Number</label>
                    <input type="text" name="serial" id="serial" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{$berita->detail_barang->serial_number}}">
                </div>
                <div class="mb-4">
                    <label for="pc_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">PC Name</label>
                    <input type="text" name="pc_name" id="pc_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{$berita->detail_barang->pc_name}}">
                </div>
                <div class="mb-4">
                    <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Password</label>
                    <input type="text" name="password" id="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{$berita->detail_barang->password}}">
                </div>
                <div class="mb-4">
                    ...
                    <select id="os" name="os" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-white">
                        ...
                        @foreach ($oss as $os)
                        @if ($os->id === $berita->detail_barang->os_id)
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="os_pk" id="os_pk" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{$berita->detail_barang->os_product_key}}">
                </div>
                <div class="mb-4">
                    ...
                    <select id="office" name="office" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-white">
                        ...
                        @if ($office->id === $berita->detail_barang->office_id)
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="office_pk" id="office_pk" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{$berita->detail_barang->office_product_key}}">
                </div>
                <div class="mb-4">
                    <label for="other" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Other</label>
                    <input type="text" name="other" id="other" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{$berita->detail_barang->other}}">
                </div>
            ...
            <div class="form-section hidden" id="section3">
                ...
                <div class="mb-4">
                    ...
                    <select id="company" name="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-white">
                        ...
                        @if ($company->id === $berita->pembelian->company_id)
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="pp" id="pp" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{$berita->pembelian->pp}}">
                </div>
                <div class="mb-4">
                    <label for="tanggal_pp" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tanggal PP</label>
                    <input type="date" name="tanggal_pp" id="tanggal_pp" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{$berita->pembelian->pp_date}}">
                </div>
                <div class="mb-4">
                    <label for="po" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Purchase Number (PO) </label>
                    <input type="text" name="po" id="po" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{$berita->pembelian->po}}">
                </div>
                <div class="mb-4">
                    <label for="tanggal_po" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tanggal PO</label>
                    <input type="date" name="tanggal_po" id="tanggal_po" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{$berita->pembelian->po_date}}">
                </div>
                <div class="mb-4">
                    <label for="SJ" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Receipt Note Number (SJ) </label>
                    <input type="text" name="sj" id="sj" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{$berita->pembelian->sj}}">
                </div>
                <div class="mb-4">
                    <label for="tanggal_sj" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tanggal SJ</label>
                    <input type="date" name="tanggal_sj" id="tanggal_sj" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{$berita->pembelian->sj_date}}">
                </div>
                <div class="mb-4">
                    <label for="tanggal_rd" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tanggal Receipt</label>
                    <input type="date" name="tanggal_rd" id="tanggal_rd" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{$berita->pembelian->receipt_date}}">
                </div>
                <div class="flex justify-between">
                    <button type="button" class="prev-btn bg-gray-500 hover:bg-gray-700 text-white py-2 px-4 rounded">Previous</button>
                    <button type="button" class="next-btn bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded">Next</button>
            ...
            <div class="form-section hidden" id="section4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="checker" id="checker" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{$berita->pengecekan->checker}}">
                </div>
                <div class="mb-4">
                    <label for="tanggal_check" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tanggal Pengecekan</label>
                    <input type="date" name="tanggal_check" id="tanggal_check" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{$berita->pengecekan->checking_date}}">
                </div>
                <div class="mb-4">
